  ...
  private renderPhaseCard(s: GameState): HTMLElement {
    ...
    if (s.phase === "awaiting_emotion" || (s.phase === "result" && !s.current)) {
      ...
      card.innerHTML = `<div class="warmth-corner-art" role="img" aria-label="温存一隅" data-testid="warmth-corner-art"></div>
        ...
        <div class="jewelry-pliers-art" role="img" aria-label="珠宝钳" data-testid="jewelry-pliers-art"></div>
        ...
        <div class="needle-file-art" role="img" aria-label="细锉" data-testid="needle-file-art"></div>
        <div class="polish-cloth-art" role="img" aria-label="抛光布" data-testid="polish-cloth-art"></div>
        <div class="polish-rouge-art" role="img" aria-label="抛光膏" data-testid="polish-rouge-art"></div>
        <div class="buff-stick-art" role="img" aria-label="绒布棒" data-testid="buff-stick-art"></div>
        <div class="soft-tweezers-art" role="img" aria-label="镊子" data-testid="soft-tweezers-art"></div>
        <div class="jewel-loupe-art" role="img" aria-label="放大镜" data-testid="jewel-loupe-art"></div>
        <div class="soft-caliper-art" role="img" aria-label="卡尺" data-testid="soft-caliper-art"></div>
        ...
        <div class="dapping-block-art" role="img" aria-label="拱形垫" data-testid="dapping-block-art"></div>
        <div class="dapping-punch-art" role="img" aria-label="冲头" data-testid="dapping-punch-art"></div>
        <div class="burnisher-art" role="img" aria-label="抛光钢" data-testid="burnisher-art"></div>
        <div class="bezel-pusher-art" role="img" aria-label="压边刀" data-testid="bezel-pusher-art"></div>
        <div class="flux-paste-art" role="img" aria-label="助焊膏" data-testid="flux-paste-art"></div>
        <div class="pickle-jar-art" role="img" aria-label="酸洗罐" data-testid="pickle-jar-art"></div>
        <div class="mini-torch-art" role="img" aria-label="小喷灯" data-testid="mini-torch-art"></div>
        <div class="solder-board-art" role="img" aria-label="焊板" data-testid="solder-board-art"></div>
        <div class="solder-wire-art" role="img" aria-label="焊丝" data-testid="solder-wire-art"></div>
        <div class="third-hand-art" role="img" aria-label="第三只手" data-testid="third-hand-art"></div>
        <div class="crucible-tongs-art" role="img" aria-label="坩埚钳" data-testid="crucible-tongs-art"></div>
        <div class="soft-crucible-art" role="img" aria-label="坩埚" data-testid="soft-crucible-art"></div>
        <div class="draw-plate-art" role="img" aria-label="抽丝板" data-testid="draw-plate-art"></div>
        <div class="draw-tongs-art" role="img" aria-label="抽丝钳" data-testid="draw-tongs-art"></div>
        <div class="ingot-mold-art" role="img" aria-label="铸锭模" data-testid="ingot-mold-art"></div>
        ...
        <div class="buff-wheel-art" role="img" aria-label="抛光轮" data-testid="buff-wheel-art"></div>
        <div class="polish-cake-art" role="img" aria-label="抛光膏" data-testid="polish-cake-art"></div>
        <div class="graver-set-art" role="img" aria-label="刻刀" data-testid="graver-set-art"></div>
        <div class="engraver-block-art" role="img" aria-label="刻台" data-testid="engraver-block-art"></div>
        <div class="soft-loupe-art" role="img" aria-label="放大镜" data-testid="soft-loupe-art"></div>
        ...
        <div class="rawhide-mallet-art" role="img" aria-label="生皮锤" data-testid="rawhide-mallet-art"></div>
        <div class="soft-nylon-hammer-art" role="img" aria-label="尼龙锤" data-testid="soft-nylon-hammer-art"></div>
        <div class="rivet-set-art" role="img" aria-label="铆钉组" data-testid="rivet-set-art"></div>
        ...
        <div class="end-cap-art" role="img" aria-label="线头帽" data-testid="end-cap-art"></div>
        <div class="soft-bail-art" role="img" aria-label="吊坠环" data-testid="soft-bail-art"></div>
        <div class="spacer-bead-art" role="img" aria-label="隔珠" data-testid="spacer-bead-art"></div>
        ...
        <div class="soft-chain-art" role="img" aria-label="链条" data-testid="soft-chain-art"></div>
        ...
        <div class="charm-set-art" role="img" aria-label="吊饰" data-testid="charm-set-art"></div>
        <div class="charm-tray-art" role="img" aria-label="饰盘" data-testid="charm-tray-art"></div>
        <div class="locket-shell-art" role="img" aria-label="盒式吊坠" data-testid="locket-shell-art"></div>
        <div class="locket-hinge-art" role="img" aria-label="合页" data-testid="locket-hinge-art"></div>
        <div class="brooch-pin-art" role="img" aria-label="胸针" data-testid="brooch-pin-art"></div>
        <div class="pin-catch-art" role="img" aria-label="别扣" data-testid="pin-catch-art"></div>
        <div class="cameo-stone-art" role="img" aria-label="浮雕石" data-testid="cameo-stone-art"></div>
        <div class="cameo-bezel-art" role="img" aria-label="嵌框" data-testid="cameo-bezel-art"></div>
        <div class="signet-ring-art" role="img" aria-label="印戒" data-testid="signet-ring-art"></div>
        <div class="wax-stick-art" role="img" aria-label="火漆" data-testid="wax-stick-art"></div>
        <div class="soft-bangle-art" role="img" aria-label="手镯" data-testid="soft-bangle-art"></div>
        <div class="bangle-core-art" role="img" aria-label="镯芯" data-testid="bangle-core-art"></div>
        <div class="soft-pendant-art" role="img" aria-label="吊坠" data-testid="soft-pendant-art"></div>
        <div class="pendant-cord-art" role="img" aria-label="丝绳" data-testid="pendant-cord-art"></div>
        <div class="cufflink-face-art" role="img" aria-label="袖扣" data-testid="cufflink-face-art"></div>
        ...
        <div class="soft-anklet-art" role="img" aria-label="脚链" data-testid="soft-anklet-art"></div>
        <div class="anklet-clasp-art" role="img" aria-label="细扣" data-testid="anklet-clasp-art"></div>
        <div class="soft-choker-art" role="img" aria-label="颈圈" data-testid="soft-choker-art"></div>
        <div class="choker-ribbon-art" role="img" aria-label="丝带扣" data-testid="choker-ribbon-art"></div>
        <div class="soft-tiara-art" role="img" aria-label="头冠" data-testid="soft-tiara-art"></div>
        ...
        <div class="soft-rosette-art" role="img" aria-label="玫瑰结" data-testid="soft-rosette-art"></div>
        <div class="rosette-core-art" role="img" aria-label="丝心" data-testid="rosette-core-art"></div>
        <div class="soft-veil-art" role="img" aria-label="薄纱" data-testid="soft-veil-art"></div>
        <div class="veil-pin-art" role="img" aria-label="别针" data-testid="veil-pin-art"></div>
        <h2>接待处</h2>
        ...
        <p class="muted" data-testid="beading-needle-line">${formatBeadingNeedleLine(s.day)}</p>
        <p class="muted" data-testid="seed-beads-line">${formatSeedBeadsLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="jewelry-pliers-line">${formatJewelryPliersLine(s.day)}</p>
        <p class="muted" data-testid="flush-cutters-line">${formatFlushCuttersLine(s.warmth)}</p>
        <p class="muted" data-testid="softpliers-aside">${formatSoftpliersAside(s.history.length)}</p>
        <p class="muted" data-testid="softpliers-encourage">${formatSoftpliersEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softpliers-pair">${formatSoftpliersPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="ring-mandrel-line">${formatRingMandrelLine(s.day)}</p>
        <p class="muted" data-testid="ring-sizer-line">${formatRingSizerLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="needle-file-line">${formatNeedleFileLine(s.day)}</p>
        <p class="muted" data-testid="polish-cloth-line">${formatPolishClothLine(s.warmth)}</p>
        <p class="muted" data-testid="softfile-aside">${formatSoftfileAside(s.history.length)}</p>
        <p class="muted" data-testid="softfile-encourage">${formatSoftfileEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softfile-pair">${formatSoftfilePair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="polish-rouge-line">${formatPolishRougeLine(s.day)}</p>
        <p class="muted" data-testid="buff-stick-line">${formatBuffStickLine(s.warmth)}</p>
        <p class="muted" data-testid="softrouge-aside">${formatSoftrougeAside(s.history.length)}</p>
        <p class="muted" data-testid="softrouge-encourage">${formatSoftrougeEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softrouge-pair">${formatSoftrougePair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-tweezers-line">${formatSoftTweezersLine(s.day)}</p>
        <p class="muted" data-testid="jewel-loupe-line">${formatJewelLoupeLine(s.warmth)}</p>
        <p class="muted" data-testid="softtweezers-aside">${formatSofttweezersAside(s.history.length)}</p>
        <p class="muted" data-testid="softtweezers-encourage">${formatSofttweezersEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softtweezers-pair">${formatSofttweezersPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-caliper-line">${formatSoftCaliperLine(s.day)}</p>
        <p class="muted" data-testid="thickness-gauge-line">${formatThicknessGaugeLine(s.warmth)}</p>
        <p class="muted" data-testid="softcaliper-aside">${formatSoftcaliperAside(s.history.length)}</p>
        <p class="muted" data-testid="softcaliper-encourage">${formatSoftcaliperEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softcaliper-pair">${formatSoftcaliperPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="jeweler-saw-line">${formatJewelerSawLine(s.day)}</p>
        <p class="muted" data-testid="saw-blade-line">${formatSawBladeLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="dapping-block-line">${formatDappingBlockLine(s.day)}</p>
        <p class="muted" data-testid="dapping-punch-line">${formatDappingPunchLine(s.warmth)}</p>
        <p class="muted" data-testid="softdapping-aside">${formatSoftdappingAside(s.history.length)}</p>
        <p class="muted" data-testid="softdapping-encourage">${formatSoftdappingEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softdapping-pair">${formatSoftdappingPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="burnisher-line">${formatBurnisherLine(s.day)}</p>
        <p class="muted" data-testid="bezel-pusher-line">${formatBezelPusherLine(s.warmth)}</p>
        <p class="muted" data-testid="softburnish-aside">${formatSoftburnishAside(s.history.length)}</p>
        <p class="muted" data-testid="softburnish-encourage">${formatSoftburnishEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softburnish-pair">${formatSoftburnishPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="flux-paste-line">${formatFluxPasteLine(s.day)}</p>
        <p class="muted" data-testid="pickle-jar-line">${formatPickleJarLine(s.warmth)}</p>
        <p class="muted" data-testid="softflux-aside">${formatSoftfluxAside(s.history.length)}</p>
        <p class="muted" data-testid="softflux-encourage">${formatSoftfluxEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softflux-pair">${formatSoftfluxPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="mini-torch-line">${formatMiniTorchLine(s.day)}</p>
        <p class="muted" data-testid="solder-board-line">${formatSolderBoardLine(s.warmth)}</p>
        <p class="muted" data-testid="softtorch-aside">${formatSofttorchAside(s.history.length)}</p>
        <p class="muted" data-testid="softtorch-encourage">${formatSofttorchEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softtorch-pair">${formatSofttorchPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="solder-wire-line">${formatSolderWireLine(s.day)}</p>
        <p class="muted" data-testid="third-hand-line">${formatThirdHandLine(s.warmth)}</p>
        <p class="muted" data-testid="softsolder-aside">${formatSoftsolderAside(s.history.length)}</p>
        <p class="muted" data-testid="softsolder-encourage">${formatSoftsolderEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softsolder-pair">${formatSoftsolderPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="crucible-tongs-line">${formatCrucibleTongsLine(s.day)}</p>
        <p class="muted" data-testid="soft-crucible-line">${formatSoftCrucibleLine(s.warmth)}</p>
        <p class="muted" data-testid="softtongs-aside">${formatSofttongsAside(s.history.length)}</p>
        <p class="muted" data-testid="softtongs-encourage">${formatSofttongsEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softtongs-pair">${formatSofttongsPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="draw-plate-line">${formatDrawPlateLine(s.day)}</p>
        <p class="muted" data-testid="draw-tongs-line">${formatDrawTongsLine(s.warmth)}</p>
        <p class="muted" data-testid="softdraw-aside">${formatSoftdrawAside(s.history.length)}</p>
        <p class="muted" data-testid="softdraw-encourage">${formatSoftdrawEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softdraw-pair">${formatSoftdrawPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="ingot-mold-line">${formatIngotMoldLine(s.day)}</p>
        <p class="muted" data-testid="melting-dish-line">${formatMeltingDishLine(s.warmth)}</p>
        <p class="muted" data-testid="softingot-aside">${formatSoftingotAside(s.history.length)}</p>
        <p class="muted" data-testid="softingot-encourage">${formatSoftingotEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softingot-pair">${formatSoftingotPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="anneal-pan-line">${formatAnnealPanLine(s.day)}</p>
        <p class="muted" data-testid="anneal-tongs-line">${formatAnnealTongsLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="bur-set-line">${formatBurSetLine(s.day)}</p>
        <p class="muted" data-testid="handpiece-line">${formatHandpieceLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="buff-wheel-line">${formatBuffWheelLine(s.day)}</p>
        <p class="muted" data-testid="polish-cake-line">${formatPolishCakeLine(s.warmth)}</p>
        <p class="muted" data-testid="softbuff-aside">${formatSoftbuffAside(s.history.length)}</p>
        <p class="muted" data-testid="softbuff-encourage">${formatSoftbuffEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softbuff-pair">${formatSoftbuffPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="graver-set-line">${formatGraverSetLine(s.day)}</p>
        <p class="muted" data-testid="engraver-block-line">${formatEngraverBlockLine(s.warmth)}</p>
        <p class="muted" data-testid="softgraver-aside">${formatSoftgraverAside(s.history.length)}</p>
        <p class="muted" data-testid="softgraver-encourage">${formatSoftgraverEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softgraver-pair">${formatSoftgraverPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="loupe-line">${formatLoupeLine(s.day)}</p>
        <p class="muted" data-testid="ring-clamp-line">${formatRingClampLine(s.warmth)}</p>
        <p class="muted" data-testid="softloupe-aside">${formatSoftloupeAside(s.history.length)}</p>
        <p class="muted" data-testid="softloupe-encourage">${formatSoftloupeEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softloupe-pair">${formatSoftloupePair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="ultrasonic-line">${formatUltrasonicLine(s.day)}</p>
        <p class="muted" data-testid="mesh-basket-line">${formatMeshBasketLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="rawhide-mallet-line">${formatRawhideMalletLine(s.day)}</p>
        <p class="muted" data-testid="soft-nylon-hammer-line">${formatSoftNylonHammerLine(s.warmth)}</p>
        <p class="muted" data-testid="softmallet-aside">${formatSoftmalletAside(s.history.length)}</p>
        <p class="muted" data-testid="softmallet-encourage">${formatSoftmalletEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softmallet-pair">${formatSoftmalletPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="rivet-set-line">${formatRivetSetLine(s.day)}</p>
        <p class="muted" data-testid="rivet-block-line">${formatRivetBlockLine(s.warmth)}</p>
        <p class="muted" data-testid="softrivet-aside">${formatSoftrivetAside(s.history.length)}</p>
        <p class="muted" data-testid="softrivet-encourage">${formatSoftrivetEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softrivet-pair">${formatSoftrivetPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="prong-opener-line">${formatProngOpenerLine(s.day)}</p>
        <p class="muted" data-testid="stone-seat-line">${formatStoneSeatLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="crimp-tube-line">${formatCrimpTubeLine(s.day)}</p>
        <p class="muted" data-testid="crimp-pliers-line">${formatCrimpPliersLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="end-cap-line">${formatEndCapLine(s.day)}</p>
        <p class="muted" data-testid="soft-bail-line">${formatSoftBailLine(s.warmth)}</p>
        <p class="muted" data-testid="softendcap-aside">${formatSoftendcapAside(s.history.length)}</p>
        <p class="muted" data-testid="softendcap-encourage">${formatSoftendcapEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softendcap-pair">${formatSoftendcapPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="spacer-bead-line">${formatSpacerBeadLine(s.day)}</p>
        <p class="muted" data-testid="bead-stopper-line">${formatBeadStopperLine(s.warmth)}</p>
        <p class="muted" data-testid="softspacer-aside">${formatSoftspacerAside(s.history.length)}</p>
        <p class="muted" data-testid="softspacer-encourage">${formatSoftspacerEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softspacer-pair">${formatSoftspacerPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="memory-wire-line">${formatMemoryWireLine(s.day)}</p>
        <p class="muted" data-testid="flush-cutter-line">${formatFlushCutterLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="soft-chain-line">${formatSoftChainLine(s.day)}</p>
        <p class="muted" data-testid="chain-nose-line">${formatChainNoseLine(s.warmth)}</p>
        <p class="muted" data-testid="softchain-aside">${formatSoftchainAside(s.history.length)}</p>
        <p class="muted" data-testid="softchain-encourage">${formatSoftchainEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softchain-pair">${formatSoftchainPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="toggle-bar-line">${formatToggleBarLine(s.day)}</p>
        <p class="muted" data-testid="toggle-ring-line">${formatToggleRingLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="charm-set-line">${formatCharmSetLine(s.day)}</p>
        <p class="muted" data-testid="charm-tray-line">${formatCharmTrayLine(s.warmth)}</p>
        <p class="muted" data-testid="softcharm-aside">${formatSoftcharmAside(s.history.length)}</p>
        <p class="muted" data-testid="softcharm-encourage">${formatSoftcharmEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softcharm-pair">${formatSoftcharmPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="locket-shell-line">${formatLocketShellLine(s.day)}</p>
        <p class="muted" data-testid="locket-hinge-line">${formatLocketHingeLine(s.warmth)}</p>
        <p class="muted" data-testid="softlocket-aside">${formatSoftlocketAside(s.history.length)}</p>
        <p class="muted" data-testid="softlocket-encourage">${formatSoftlocketEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softlocket-pair">${formatSoftlocketPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="brooch-pin-line">${formatBroochPinLine(s.day)}</p>
        <p class="muted" data-testid="pin-catch-line">${formatPinCatchLine(s.warmth)}</p>
        <p class="muted" data-testid="softbrooch-aside">${formatSoftbroochAside(s.history.length)}</p>
        <p class="muted" data-testid="softbrooch-encourage">${formatSoftbroochEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softbrooch-pair">${formatSoftbroochPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="cameo-stone-line">${formatCameoStoneLine(s.day)}</p>
        <p class="muted" data-testid="cameo-bezel-line">${formatCameoBezelLine(s.warmth)}</p>
        <p class="muted" data-testid="softcameo-aside">${formatSoftcameoAside(s.history.length)}</p>
        <p class="muted" data-testid="softcameo-encourage">${formatSoftcameoEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softcameo-pair">${formatSoftcameoPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="signet-ring-line">${formatSignetRingLine(s.day)}</p>
        <p class="muted" data-testid="wax-stick-line">${formatWaxStickLine(s.warmth)}</p>
        <p class="muted" data-testid="softsignet-aside">${formatSoftsignetAside(s.history.length)}</p>
        <p class="muted" data-testid="softsignet-encourage">${formatSoftsignetEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softsignet-pair">${formatSoftsignetPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-bangle-line">${formatSoftBangleLine(s.day)}</p>
        <p class="muted" data-testid="bangle-core-line">${formatBangleCoreLine(s.warmth)}</p>
        <p class="muted" data-testid="softbangle-aside">${formatSoftbangleAside(s.history.length)}</p>
        <p class="muted" data-testid="softbangle-encourage">${formatSoftbangleEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softbangle-pair">${formatSoftbanglePair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-pendant-line">${formatSoftPendantLine(s.day)}</p>
        <p class="muted" data-testid="pendant-cord-line">${formatPendantCordLine(s.warmth)}</p>
        <p class="muted" data-testid="softpendant-aside">${formatSoftpendantAside(s.history.length)}</p>
        <p class="muted" data-testid="softpendant-encourage">${formatSoftpendantEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softpendant-pair">${formatSoftpendantPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="cufflink-face-line">${formatCufflinkFaceLine(s.day)}</p>
        <p class="muted" data-testid="cuff-post-line">${formatCuffPostLine(s.warmth)}</p>
        <p class="muted" data-testid="softcufflink-aside">${formatSoftcufflinkAside(s.history.length)}</p>
        <p class="muted" data-testid="softcufflink-encourage">${formatSoftcufflinkEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softcufflink-pair">${formatSoftcufflinkPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-stud-line">${formatSoftStudLine(s.day)}</p>
        <p class="muted" data-testid="butterfly-back-line">${formatButterflyBackLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="soft-anklet-line">${formatSoftAnkletLine(s.day)}</p>
        <p class="muted" data-testid="anklet-clasp-line">${formatAnkletClaspLine(s.warmth)}</p>
        <p class="muted" data-testid="softanklet-aside">${formatSoftankletAside(s.history.length)}</p>
        <p class="muted" data-testid="softanklet-encourage">${formatSoftankletEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softanklet-pair">${formatSoftankletPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-choker-line">${formatSoftChokerLine(s.day)}</p>
        <p class="muted" data-testid="choker-ribbon-line">${formatChokerRibbonLine(s.warmth)}</p>
        <p class="muted" data-testid="softchoker-aside">${formatSoftchokerAside(s.history.length)}</p>
        <p class="muted" data-testid="softchoker-encourage">${formatSoftchokerEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softchoker-pair">${formatSoftchokerPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-tiara-line">${formatSoftTiaraLine(s.day)}</p>
        <p class="muted" data-testid="tiara-comb-line">${formatTiaraCombLine(s.warmth)}</p>
        <p class="muted" data-testid="softtiara-aside">${formatSofttiaraAside(s.history.length)}</p>
        <p class="muted" data-testid="softtiara-encourage">${formatSofttiaraEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softtiara-pair">${formatSofttiaraPair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-barrette-line">${formatSoftBarretteLine(s.day)}</p>
        <p class="muted" data-testid="barrette-spring-line">${formatBarretteSpringLine(s.warmth)}</p>
        ...
        <p class="muted" data-testid="soft-rosette-line">${formatSoftRosetteLine(s.day)}</p>
        <p class="muted" data-testid="rosette-core-line">${formatRosetteCoreLine(s.warmth)}</p>
        <p class="muted" data-testid="softrosette-aside">${formatSoftrosetteAside(s.history.length)}</p>
        <p class="muted" data-testid="softrosette-encourage">${formatSoftrosetteEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softrosette-pair">${formatSoftrosettePair(s.day, s.warmth)}</p>
        <p class="muted" data-testid="soft-veil-line">${formatSoftVeilLine(s.day)}</p>
        <p class="muted" data-testid="veil-pin-line">${formatVeilPinLine(s.warmth)}</p>
        <p class="muted" data-testid="softveil-aside">${formatSoftveilAside(s.history.length)}</p>
        <p class="muted" data-testid="softveil-encourage">${formatSoftveilEncourage(s.circulationsToday)}</p>
        <p class="muted" data-testid="softveil-pair">${formatSoftveilPair(s.day, s.warmth)}</p>
